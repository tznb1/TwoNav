...
$title='编辑链接';$awesome=true; require 'header.php';  
?>
<style>
     ...
     <form class="layui-form layuimini-form" lay-filter="form">
        ...
        <div class="layui-form-item" style="display:none;">
            ...
            <div class="layui-input-block">
                <input type="text" id = "lid" name="lid" required  lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
    ...
    require 'link_extend.php';
        ...
        <div class="layui-form-item">
            <div class="layui-input-block layui-btn-group">
                ...
                <button class="layui-btn layui-btn-normal" lay-submit lay-filter="edit_link" id="edit_link">更新</button>
            </div>
        </div>
     </form>
    </div>
